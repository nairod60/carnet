...
w("  grossissait pas quoi qu'il mange ; depuis peu, un peu de gras au ventre. Le suivi du tour de taille (le lundi) sert à ça.")
w("- Matériel : haltères, banc inclinable, barre de traction, un élastique (rééducation). Séances chez lui, environ une heure.")
...
w("  Diagnostic (le sien) : tendinite, conflit sous-acromial → programme de recentrage de la tête humérale le mercredi (séance R).")
w("  Tête en avant (dos voûté) : rentrés de menton et extensions thoraciques dans la même séance. Le 22/09, tendon distal du biceps")
w("  sensible dans le pli du coude (reprise) : curls et tirages à −20-30 % pendant 2-3 semaines, descente lente, le lendemain décide.")
w("- Prend du Dafalgan codéiné à l'occasion (maux de tête) : sans effet sur le muscle, pas d'interaction avec la créatine.")
w("- Préférences : les salades de riz au thon plutôt qu'au poulet, avec du maïs (boîte sans sucres ajoutés), des tomates, du concombre et un œuf dur ; pas de")
w("  sardines, pas de courgettes ; le steak haché seulement le soir ; trouve les assiettes volumineuses, d'où les calories du surplus")
w("  mises dans le shake (lait entier, dattes) plutôt que dans l'assiette. Pas de flocons d'avoine chez lui.")
w("  Pas de saumon (ni en boîte ni en pavé, retirés le 19/09/2026) : le poisson, c'est du cabillaud ou du colin frais, dimanche et")
w("  lundi soir (le samedi soir, c'est poulet-pommes de terre, à sa demande). Les lentilles lui plaisent (un dîner steak haché-lentilles par semaine).")
w("- Il a un **air fryer** et préfère les pommes de terre à l'air fryer avec une cuillère à café d'huile (5 g) aux pommes de terre")
w("  vapeur : toutes les pommes de terre du dîner passent à l'air fryer (200 °C, 18-22 min), le poulet et le poisson aussi.")
w("")
...
w("- Glucides autour des séances, sans sucre ajouté (riz, pâtes, pommes de terre à l'air fryer, pain complet, fruits, dattes). Pas de flocons d'avoine (il n'en a pas).")
...
w("- Whey : 30 g par prise, deux prises par jour (10 h, puis après la séance ou l'après-midi), dans 250 ml de lait entier")
w("  (depuis le 14 septembre : plus de calories sans plus de volume). HSN Evowhey depuis le 19/09/2026 (Isostar avant) ; le plan")
w("  garde le libellé « Whey Isostar », les valeurs sont équivalentes.")
w("- Thon en boîte : 3 salades par semaine maximum. 3 × 130 g de listao ≈ 50 µg de mercure, soit environ la moitié de la dose")
w("  hebdomadaire tolérable EFSA (1,3 µg/kg, reprise par l'ANSES : 91 µg pour 70 kg) : marge prudente, pas un plafond réglementaire.")
w("- Poids toujours donnés **crus** (avant cuisson). Table cru → cuit dans l'appli (onglet Repas).")
w("- **Courses le samedi** : la semaine de repas va du samedi au samedi (l'appli, elle, affiche toujours lundi → dimanche).")
w("  Le poisson frais se mange dimanche et lundi soir (samedi soir : poulet-pommes de terre) ; les 7 œufs durs se cuisent le samedi soir.")
w("- Substitutions admises sans changer le plan : légumes interchangeables à poids égal (haricots verts, concombre, tomate,")
w("  poivron) ; steak plus léger que prévu → un œuf en plus ; une cuillère à café (10-15 g) de crème de marrons dans")
...
w("- **Mensurations une fois par mois** (premier lundi du mois ; mètre ruban, Fitdays, relâché, même endroit) : cou, poitrine, biceps, taille, abdomen,")
w("  cuisses, mollets. Livrées dans `mesures.json` (`mensurations`) et affichées dans Suivi avec l'écart depuis la mesure précédente.")
w("  Première mesure le 21/09/2026 : cou 36,6 · poitrine 95,2 · biceps 36,7 / 36,7 · taille 80,2 · abdomen 84,9 · cuisses 52,9 / 53,6 ·")
w("  mollets 37,5 / 39,4 cm. Les moyennes hebdomadaires de la balance s'ajoutent une fois la semaine finie, jamais en cours de semaine.")
...
w("")
w("Lundi J1, mardi J2, jeudi J3, vendredi J4 : musculation. Mercredi R : rééducation cou + épaule, 15-20 min, léger (jour de repos côté")
w("nutrition, pas de +300 kcal). Week-end : repos (marche bienvenue). Haltères + banc + barre de traction + élastique.")
w("")
for s in p.SEANCES:
...
w("- 11 septembre, semaine du 14 : maïs et œuf dur dans toutes les salades (riz 70 g cru, tomates et concombre 100 g), pommes de")
w("  terre à l'air fryer avec 5 g d'huile, avoine remplacée par 40 g de dattes à côté du shake, lait entier dans les shakes, pain")
w("  60 g au petit-déjeuner, 30 g de dattes après la séance, omelette du dimanche remplacée par un pavé de saumon à l'air fryer,")
w("  7 œufs durs cuits le dimanche. Volume des assiettes en baisse d'environ 9 % sur la semaine (seul le déjeuner du jeudi grossit")
w("  d'une trentaine de grammes), calories égales (2727 kcal/j en moyenne contre 2712).")
w("- 19 septembre : saumon retiré (boîte et pavé) → cabillaud dimanche et lundi soir, poulet-pommes de terre le samedi soir ; un dîner steak haché-lentilles à la")
w("  tomate le mardi (lentilles vertes sèches, 100 g) ; salade piémontaise au poulet le mardi midi (pommes de terre du dîner de")
w("  lundi) ; salade au poulet le vendredi midi ; courses et œufs durs le samedi. Whey HSN Evowhey (même dosage).")
w("- 21 septembre : mensurations du lundi dans l'appli (carte « Mensurations » de Suivi, fusion depuis `mesures.json`) ; tour de taille")
w("  désormais le lundi. Balance 30/08 → 21/09 : 70,4 → 72,0 kg dont 1 à 1,5 kg d'eau de créatine ; % gras +1,3 pt = bruit d'impédance.")
w("- 23 septembre : séance R du mercredi (cou + recentrage de l'épaule, 11 exercices, fiche illustrée dans plan/fiches/). Mensurations")
w("  ramenées à une fois par mois. Sèche envisagée plutôt avril → juin (avant l'été) au lieu de février : à confirmer, la règle")
w("  de pilotage dit encore « fin janvier ».")
w("")
