...
SEANCES = [
 dict(id="J1", jour="Lundi", titre="Haut A — Poussée",
      focus="Pectoraux (la seule fois de la semaine), triceps, deltoïde latéral",
      exos=[
   ("Pectoraux","Développé incliné haltères, PRISE NEUTRE","4","8-10","90 s",
   ...
   ("Triceps","Extension couché sur le banc, prise neutre","4","10-12","60 s",
 ...
 dict(id="J3", jour="Jeudi", titre="Haut B — Tirage",
      focus="Dos, deltoïde postérieur, biceps — la séance qui protège ton épaule",
      exos=[
   ("Dos","Tractions, prise supination ou neutre","4","max","120 s",
    "LARGEUR D'ÉPAULES, jamais large : la prise large bloque l'omoplate. Si tu ne fais pas 5 reps, fais des négatives de 5 s."),
   ("Dos","Rowing haltères buste penché","4","8-10","90 s","Buste à 45°, tire vers le nombril, coudes près du corps."),
